...
">
			<nav>
				<ul>
					<li><a href="#section-1" class="icon-profile"><span>ORDERS</span></a>
					</li>
					<li><a href="/viewCakes" class="icon-menut-items"><span>CAKES</span></a>
					</li>
                  ...
                  <table class="table table-striped notifications">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="width:65%">
                          <a href="order-{{$or['id']}}-view"><B>Order ID: CK{{$or['id']}}</B> - {{$or['grand_total']}} AED - {{$or['delivery_date']}}</a>
                        </td>
                        <td style="width:35%">
                          </td>
                      </tr>
