...
<form action="editSlider" method="POST" enctype='multipart/form-data'>
               {{ csrf_field() }}
               <input type="text" name="slider_id" value="{{$slider['id']}}" />
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="description" value="{{$slider['description']}}" class="form-control" placeholder="Enter slider description">
              </div>
<div class="col-md-5">
  <img src="{{$slider['image']}}" width="300"/>
</div>
<div class="col-md-7">
              <div class="form-group">
					...
					<div class="wrapper_indent" style="padding-left:0px">
						<div class="add_more_cat"><button type="submit" class="btn_1" style="float:right">Update Slider</button></div>
