...
">
			<nav>
				<ul>
					<li><a href="admin.html#section-1" class="icon-profile"><span>Main info</span></a>
					</li>
					<li><a href="admin.html#section-2" class="icon-menut-items"><span>Menu</span></a>
					</li>
					<li><a href="admin.html#section-3" class="icon-settings"><span>Settings</span></a>
					</li>
				</ul>
			</nav>
			<div class="content">
				...
				<section id="section-2">
					...
					<div class="wrapper_indent">
						...
						<div class="menu-item-section clearfix">
							<h4>Menu item #1</h4>
							<div><a href="admin.html#0"><i class="icon_plus_alt"></i></a><a href="admin.html#0"><i class="icon_minus_alt"></i></a>
							</div>
						</div>
					...
					<div class="wrapper_indent">
						<div class="add_more_cat"><a href="admin.html#0" class="btn_1">Save now</a> <a href="admin.html#0" class="btn_1">Add menu category</a> </div>
					</div><!-- End wrapper_indent -->
