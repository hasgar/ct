...
<div class="form-group">
  <label>Shaped Cake Charge</label>
  <input type="text" name="shaped_charge" id="shaped_charge" value="{{$settings['shaped_charge']}}"  class="form-control" placeholder="Enter shaped cake amount">
</div>
</div>
<div class="col-md-6" >
<div class="form-group">
  <label>Photo Cake Charge</label>
  <input type="text" name="photo_charge" id="photo_charge" value="{{$settings['photo_charge']}}" class="form-control" placeholder="Enter photo cake amount">
</div>
</div>
