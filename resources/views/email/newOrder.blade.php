<html xmlns="http://www.w3.org/1999/xhtml" hola_ext_inject="disabled"><head>
	...
	<body bgcolor="#E1E1E1" leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0">
		...
		<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tbody><tr>
																	<td align="center" valign="top" class="textContent" style="
    PADDING-TOP: 17PX;
    PADDING-BOTTOM: 12PX;
    background-color: #dd292a;
    border-bottom: 2px solid #BB0A0A;
">
																		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;"><img src="http://www.caketreeonline.com/img/http://www.caketreeonline.com/img/cake_tree_email_logo.png" /></h1>
																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tbody><tr>
																				<td align="left" class="textContent">
																					<h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom: 0px;text-align:left;background-color: #F5E88D;text-transform: uppercase;padding-left: 4px;">{{ $order["your_name"] }}</h3>
                                                                                    <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;background-color: #FDF4B7;padding-left: 4px;">User Phone: <a href="callto:{{ $order["your_phone"] }}">{{ $order["your_phone"] }}</a><br>Reciever Phone: <a href="callto:{{ $order["reciever_phone"] }}">{{ $order["reciever_phone"] }}</a><br>{{ $user["email"] }}<br>{{ $emirate["name"] }}<br>{{ $order["flat_no_and_builder"] }}<br>{{ $order["street_address"] }}<br>{{ $order["landmark"] }}</div>

                                                                                        <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top: 13px;color:#5F5F5F;line-height:135%;background-color: #FDF4B7;padding-left: 4px;">No of Items: <b>{{ count($cakes) }}</b><BR>Date:<b>{{ $order["delivery_date"] }}</b><br>Timeslot:<b>{{ $timeslot["timeslot"] }}</b></div>
																				</td>
																			</tr>
																		</tbody></table>
																	</td>
	...
	<!-- cake from here LOOOPPPP HERE START -->
...
">
																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tbody><tr>
																				<td valign="top" class="textContent">
																					<h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size: 16px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Cake Name &amp; ID:</h3>
																					<div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color: #3C3A3A;line-height:135%;background-color: #B7E8C9;padding: 3px;padding-left: 8px;">{{ CakeController::getCakeNameById($cake["cake_id"]) }} <?php echo "(CK".$cake['cake_id'].")"; ?></div>
																				</td>
																			</tr>
																		</tbody></table>
																		<!-- // CONTENT TABLE -->
...
">
																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tbody><tr>
																				<td valign="top" class="textContent">
																					<h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size: 16px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Vendor:</h3>
																					<div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color: #3C3A3A;line-height:135%;background-color: #B7E8C9;padding: 3px;padding-left: 8px;"><?PHP echo "CakeTree" ?></div>
																				</td>
																			</tr>
																		</tbody></table>
																		<!-- // CONTENT TABLE -->
...
">
																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tbody><tr>
																				<td valign="top" class="textContent">
																					<h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size: 16px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Weight:</h3>
																					<div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color: #3C3A3A;line-height:135%;background-color: #B7E8C9;padding: 3px;padding-left: 8px;"><?PHP echo $cake['kg']; ?></div>
																				</td>
	<td valign="top" class="textContent">
																					<h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size: 16px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;padding-left: 3px;">Quantity:</h3>
																					<div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color: #3C3A3A;line-height:135%;background-color: #B7E8C9;padding: 3px;padding-left: 7px;border-left: #FFFFFF 3px solid;"><?PHP echo $cake['quantity']; ?></div>
																				</td>
<td valign="top" class="textContent">
...
">
																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tbody><tr>
																				<td valign="top" class="textContent">
																					<h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size: 16px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Message on Cake</h3>
...
$s_msg = str_replace("&lt;","<",$cake['message']);
...
">
	...
	<td valign="top" class="textContent" style="width: 50%;">
																					...
																					<div style="text-align:left;border-left:3px solid #fff;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color: #3C3A3A;line-height:135%;background-color: #B7E8C9;padding: 3px;padding-left: 8px;"><a href="http://www.caketreeonline.com/<?php if($cake['is_photo'] == '1') echo "uploads/".$cake['photo_url']; else echo "img/cakes/".str_replace(" ","_",strtolower(CakeController::getCakeNameById($cake['cake_id'])))."_".$cake['cake_id']."_large_1.jpg"; ?>">Click Here</a></div>
																				</td>
																			</tr>
																		</tbody></table>
																		<!-- // CONTENT TABLE -->
...
">Order Out for Delivery</a></div>
    ...
    color: #fff;
">Successfully Delivered</a></div>
                                                                                    <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top: 8px;color: #FBFBFB;line-height:135%;background-color: #F52626;"><a href="http://www.caketreeonline.com/changeStatus/<?php echo $order["id"]; ?>&t=<?php echo $order["token"]; ?>&s=8" style="
    color: #fff;
">Order Cancelled</a></div>
																				</td>
																			</tr>
																		</tbody></table>
																		<!-- // CONTENT TABLE -->
